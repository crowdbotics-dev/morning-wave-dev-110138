"""
Django settings for morning_wave_dev_110138 project.
...
ROOT_URLCONF = 'morning_wave_dev_110138.urls'
...
WSGI_APPLICATION = 'morning_wave_dev_110138.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_wave_dev_110138 API",
    "DESCRIPTION": "API documentation for morning_wave_dev_110138 App",
    "VERSION": "v1",
}
